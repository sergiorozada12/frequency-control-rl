...
non-markovian problems. Double-Q learning and Dueling architecture is introduced.
...
mainNet = architectures.dueling_drqn(h_s,lstm_M,'main')
targetNet = architectures.dueling_drqn(h_s,lstm_T,'target')
...
with tf.Session() as session:
    ...
    saver.save(session,"models/dueling_ddrqn")
    rl.saveData("cummulative_reward_dueling_ddrqn.pickle",cumm_r_list)