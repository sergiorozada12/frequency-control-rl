...
by using shared information with the critics. Operation is decentralized just using the actors. The
implementation of this script deals with the Secondary Control.
...
with tf.Session() as session:
    ...
    for i in range(episodes):
        ...
        for j in range(steps):
            ...
            a_1 = a_1[0,0] + epsilon*np.random.normal(0.0,0.4)
            ...
            a_2 = a_2[0,0] + epsilon*np.random.normal(0.0,0.4)
    ...
    saver.save(session,"models/maddpg_secondary")
    rl.saveData("cummulative_reward_maddpg_secondary.pickle",cumm_r_list)