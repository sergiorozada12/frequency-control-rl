...
such as experience replay, double dqn and dueling architecture has been used.
...
mainNet = architectures.dueling_dqn()
targetNet = architectures.dueling_dqn()
...
with tf.Session() as session:
    ...
    saver.save(session,"models/dueling_ddqn")
    rl.saveData("cummulative_reward_dueling_ddqn.pickle",cumm_r_list)