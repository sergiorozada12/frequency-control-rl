...
model_path = "../models/mcpg_continuous"
reward_path = "cummulative_reward_mcpg_continuous.pickle"
...
with tf.Session() as session:      
    ...
    net = architectures.drqn_continuous_action_pg(h_s,lstm,'net')
    ...
    for i in range(steps):
        ...
        a, new_state = session.run([net.pi_sample,net.rnn_state],
...
plt.figure(1)
plt.scatter(np.arange(50000),reward[0:50000])
plt.xlabel('Episodes')
