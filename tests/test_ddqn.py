...
model_path = "../models/ddqn"
reward_path = "cummulative_reward_ddqn.pickle"
...
with tf.Session() as session:      
    ...
    for i in range(steps):
        ...
        a = session.run(net.predict, feed_dict={net.inputs: np.array(current_f).reshape(1,1)})
        a = a[0]
